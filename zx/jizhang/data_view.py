...
class InitView(APIView):
	...
	def post(self, request, format=None):
		...
		City.objects.create(name='南京')
		City.objects.create(name='上海')
		City.objects.create(name='芜湖')
		City.objects.create(name='昆山')
		...
		if self.debug:
			...
			BuyPlace.objects.create(place_area='南京', place_name='金盛国际家具')
			BuyPlace.objects.create(place_area='南京', place_name='卡子门')
			BuyPlace.objects.create(place_area='南京', place_name='红太阳装饰城')
			BuyPlace.objects.create(place_area='南京', place_name='苏宁易购')
			BuyPlace.objects.create(place_area='南京', place_name='国美')
			BuyPlace.objects.create(place_area='南京', place_name='苏果超市')
			BuyPlace.objects.create(place_area='南京', place_name='红星美凯龙卡子门店')
			BuyPlace.objects.create(place_area='南京', place_name='苏宁乐购仕')
			BuyPlace.objects.create(place_area='南京', place_name='大洋百货')
			BuyPlace.objects.create(place_area='南京', place_name='沃尔玛新街口店')
			BuyPlace.objects.create(place_area='南京', place_name='金鹰江宁店')
			BuyPlace.objects.create(place_area='南京', place_name='京东商城')


			Tag.objects.all().delete()
			category = Category.objects.get(name='家电')
			Tag.objects.create(category=category, name='洗衣机')
			Tag.objects.create(category=category, name='滚筒洗衣机')
			Tag.objects.create(category=category, name='西门子洗衣机')
			Tag.objects.create(category=category, name='空调')
			Tag.objects.create(category=category, name='中央空调')
			Tag.objects.create(category=category, name='32寸液晶电视尺寸')
			Tag.objects.create(category=category, name='42寸液晶电视尺寸')
			Tag.objects.create(category=category, name='液晶电视')
			Tag.objects.create(category=category, name='豆浆机')

			TagDataWithCity.objects.all().delete()

			tag = Tag.objects.get(name='洗衣机')
			TagDataWithCity.objects.create(city=city, tag=tag, cited_times=2414, average_price=2600, min_price=1200, max_price=4500)

			tag = Tag.objects.get(name='滚筒洗衣机')
			TagDataWithCity.objects.create(city=city, tag=tag, cited_times=1671, average_price=2700, min_price=1300, max_price=5500)

			tag = Tag.objects.get(name='西门子洗衣机')
			TagDataWithCity.objects.create(city=city, tag=tag, cited_times=2411, average_price=3222, min_price=2100, max_price=7550)

			tag = Tag.objects.get(name='空调')
			TagDataWithCity.objects.create(city=city, tag=tag, cited_times=3511, average_price=2800, min_price=2700, max_price=5922)

			tag = Tag.objects.get(name='中央空调')
			TagDataWithCity.objects.create(city=city, tag=tag, cited_times=1520, average_price=7520, min_price=3900, max_price=15000)

			tag = Tag.objects.get(name='32寸液晶电视尺寸')
			TagDataWithCity.objects.create(city=city, tag=tag, cited_times=2411, average_price=3222, min_price=2100, max_price=7550)

			tag = Tag.objects.get(name='42寸液晶电视尺寸')
			TagDataWithCity.objects.create(city=city, tag=tag, cited_times=2411, average_price=3222, min_price=2100, max_price=7550)

			tag = Tag.objects.get(name='液晶电视')
			TagDataWithCity.objects.create(city=city, tag=tag, cited_times=2411, average_price=3222, min_price=2100, max_price=7550)

			tag = Tag.objects.get(name='豆浆机')
			TagDataWithCity.objects.create(city=city, tag=tag, cited_times=1400, average_price=852, min_price=400, max_price=1520)
			...
			cited_time = 2334
			BrandDataWithCityTag.objects.create(city=city, tag=tag, brand=brand, cited_times=cited_time)
			shop = BuyPlace.objects.get(place_area='南京', place_name='红太阳装饰城')
			BuyPlaceDataWithCity.objects.create(city=city, buy_place_name=shop.place_name, cited_times=2322)

			tag = Tag.objects.get(name='洗衣机')
			brand = Brand.objects.get(name='西门子')
			cited_time = 2554
			BrandDataWithCityTag.objects.create(city=city, tag=tag, brand=brand, cited_times=cited_time)
			shop = BuyPlace.objects.get(place_area='南京', place_name='苏宁易购')
			BuyPlaceDataWithCity.objects.create(city=city, buy_place_name=shop.place_name, cited_times=4333)
...
'''
			...
			BuyPlaceDataWithCity.objects.create(tag=tag, city=city, brand=brand,buy_city=shop.city, buy_place=shop.name, cited_times=4333)
