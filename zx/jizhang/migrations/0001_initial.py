# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-11-12 19:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version_code', models.PositiveIntegerField(default=1, verbose_name='版本号')),
                ('version_name', models.CharField(max_length=10, verbose_name='版本名')),
                ('update_log', models.TextField(blank=True, null=True, verbose_name='更新日志')),
                ('download_url', models.FileField(upload_to='App', verbose_name='文件链接')),
                ('cover_update', models.CharField(blank=True, max_length=20, null=True)),
                ('cover_start_date', models.DateTimeField(blank=True, null=True, verbose_name='封面启用时间')),
                ('cover_end_date', models.DateTimeField(blank=True, null=True, verbose_name='封面结束时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='spend_detail_set', to=settings.AUTH_USER_MODEL, to_field='username', verbose_name='用户名')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
