# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-06-19 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.CharField(blank=True, choices=[('<5万', '<5万'), ('<10万', '<10万'), ('10-15万', '10-15万'), ('15-20万', '15-20万'), ('20-30万', '20-30万'), ('30-50万', '30-50万'), ('50-80万', '50-80万'), ('80-100万', '80-100万'), ('>100万', '>100万')], max_length=20, null=True, verbose_name='预算')),
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='jizhang.DecorationCompany', to_field='name', verbose_name='装修公司')),
